...
docker run -i -t -p 8082:80 -v /nail/srv/configs/swagger.yaml:/nail/srv/configs/swagger.yaml -v /nail/etc/services:/nail/etc/services --name swagger-ui swagger-ui-builder
